...
const FName ADomPawn::EngineAudioRPM("RPM");
...
ADomPawn::ADomPawn()
{
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UDomWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UDomWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UDomWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UDomWheelRear::StaticClass();
...
void ADomPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ADomPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ADomPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ADomPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ADomPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ADomPawn::EnableIncarView(const bool bState)
{
...
void ADomPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ADomPawn::UpdatePhysicsMaterial()
{
